    ...
    <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <div className="p-3 bg-white rounded border">
            <p className="text-sm text-gray-600">
              <strong>Important:</strong> Submitting this form does NOT
              guarantee a spot in the program. There will be a selection process
              by the SOC (Scientific Organizing Committee).
            </p>
          </div>
        </div>
        ...
        <div className="text-center text-sm text-gray-600 mt-4">
          <p>
            This is an application form for CAM-SUST Summer School on
            Astrophysics 2025
          </p>
        </div>
      </div>
